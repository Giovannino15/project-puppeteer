...
<template>
    ...
    <div
        class="relative sm:flex sm:justify-center sm:items-center min-h-screen  bg-center bg-dots-darker bg-gray-800/50  selection:bg-red-500 selection:text-white">
        <div v-if="canLogin" class="sm:fixed sm:top-0 sm:right-0 p-6 text-end">
            ...
            <template v-else>
                <div>
                    <Link :href="route('login')" class="text-4xl font-extrabold text-white mr-5">Inicia sesión</Link>

                    <Link v-if="canRegister" :href="route('register')"
                        class="text-4xl text-center font-extrabold text-white">Registrate</Link>
                </div>
            </template>
        </div>
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="80px"
                    width="80px" version="1.1" id="Layer_1" viewBox="0 0 505 505" xml:space="preserve">
            ...
            <div class="mt-16">
                <div class="w-[40rem]">
                    <div
                        class="scale-100 p-6 bg-gray-800/50 bg-gradient-to-bl from-gray-700/50 via-transparent ring-1 ring-inset ring-white/5 rounded-lg  shadow-gray-500/20 shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>

                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Simulador de Facturas</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Creado con Laravel y Scrapeado con Puppeteer.
